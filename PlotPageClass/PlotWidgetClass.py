...
class PlotWidgetClass:
    ...
    def plotSBK(self):
        ...
        try:
            ...
            self.__primaryLine=self.__plotWidget.plot(temptXList , temptYList ,pen = sbkPen)
        except:
            print("error plotSBK")
...
#--------------------------------------------------------------------------------------
    ...
    def addDataSBK(self , valueList:list): # return normalization dataset
        self.__addData(valueList , self.__dataLineSBK)
        return self.__dataLineSBK
    ...
    def __addData(self , valueList:list , temptDataLine:list):
        ...
        temptDataLine.append([temptXList , temptYList])

        # reset plotWidget range
        try:
            temptMaxX = max(temptXList)+1
